<template>
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" 
    ...
    <path d="M0 0c-41.353 0-75 33.647-75 75s33.647 75 75 75 75-33.647 75-75S41.353 0 0 0Z"
          ...
          transform="translate(256 257)" fill="none" stroke="currentColor" stroke-width="30" stroke-linecap="round"
          stroke-linejoin="round" stroke-miterlimit="10" stroke-dasharray="none" stroke-opacity=""
          data-original="currentColor"></path></g></g></svg>
</template>